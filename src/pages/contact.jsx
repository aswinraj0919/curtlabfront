...
export default function Bottom() {
    ...
    const validatePhone = (phone) => {
        // Allows international format: +971501234567, 0501234567, +1-234-567-8900
        ...
        switch (name) {
            ...
            case 'lastName':
                ...
                if (!validateName(trimmedValue)) {
                    return `Please enter a valid ${name === 'firstName' ? 'first' : 'last'} name (letters only)`;
                }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Map form fields to Google Forms entry IDs with trimmed values
            formDataToSubmit.append(ENTRY_IDS.firstName, formData.firstName.trim());
            formDataToSubmit.append(ENTRY_IDS.lastName, formData.lastName.trim());
            formDataToSubmit.append(ENTRY_IDS.phone, formData.phone.trim());
            formDataToSubmit.append(ENTRY_IDS.email, formData.email.trim());
            formDataToSubmit.append(ENTRY_IDS.projectDetails, formData.projectDetails.trim());
    ...
    const handleSubmitAlternative = (e) => {
        ...
        // Add form fields with trimmed values
                ...
                <section className="contact-section" id="contact" aria-label="Contact us">
                    <div className="contact-container">
                        <div className="contact-form-wrapper">
                            ...
                            >
                                ...
                                <div className="form-group">
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        onBlur={handleBlur}
                                        className={shouldShowError('projectDetails') ? 'error' : ''}
                                    ></textarea>
                                    {shouldShowError('projectDetails') && (
                                        <span className="error-message">{errors.projectDetails}</span>
                                    )}
                                </div>
                            ...
                            <div className="link">
                                <a href="tel:+971507315523" target='block'>

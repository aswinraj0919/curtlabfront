                    ...
                    <div className="contact-container">
                        <div className="contact-form-wrapper">
                            ...
                            <div class="link">
                                ...
                                <a href="https://maps.app.goo.gl/djHaaPNaMRXfARtv9"><svg width="63" height="90" viewBox="0 0 63 90" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M31.5 42.75C28.5163 42.75 25.6548 41.5647 23.545 39.455C21.4353 37.3452 20.25 34.4837 20.25 31.5C20.25 28.5163 21.4353 25.6548 23.545 23.545C25.6548 21.4353 28.5163 20.25 31.5 20.25C34.4837 20.25 37.3452 21.4353 39.455 23.545C41.5647 25.6548 42.75 28.5163 42.75 31.5C42.75 32.9774 42.459 34.4403 41.8936 35.8052C41.3283 37.1701 40.4996 38.4103 39.455 39.455C38.4103 40.4996 37.1701 41.3283 35.8052 41.8936C34.4403 42.459 32.9774 42.75 31.5 42.75ZM31.5 0C23.1457 0 15.1335 3.31874 9.22614 9.22614C3.31874 15.1335 0 23.1457 0 31.5C0 55.125 31.5 90 31.5 90C31.5 90 63 55.125 63 31.5C63 23.1457 59.6813 15.1335 53.7739 9.22614C47.8665 3.31874 39.8543 0 31.5 0Z" fill="white" />
                                </svg>

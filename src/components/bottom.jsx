                ...
                <section className="contact-section" id="contact" aria-label="Contact us">
                    <div className="contact-container">
                        <div className="contact-form-wrapper">
                            ...
                            <div class="link">
                                <a target='block' href="tel:+1234567890"><svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a target='block' href="mail:info@curtlab.ae"><svg width="40" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
